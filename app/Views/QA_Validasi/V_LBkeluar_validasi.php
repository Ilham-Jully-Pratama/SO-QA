...
<div id="page-wrapper">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Laporan Barang Keluar Validasi</h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-inline">
                                <form class="form-inline" action="<?= site_url('/caridata_keluar_validasi') ?>" method="post">
                            ...
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <?php foreach ($barang as $dd) : ?>
                                    <tr class="odd gradeX">
                                        ...
                                        <td><a type="button" class="btn btn-info" href="<?= base_url('/ubah_barang_keluar_validasi/' . $dd['kodebarang']) ?>" id="buttonupdate" style="margin:auto;height:20%"><i class="fa fa-pencil" aria-hidden="true"></i></a></td>
                                        <td>
                                            <form action="<?= site_url('/deletebarangkeluar_validasi/'.$dd['id']) ?>" method="post">
