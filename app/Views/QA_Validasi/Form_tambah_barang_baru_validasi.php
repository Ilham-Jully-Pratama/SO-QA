...
<div id="page-wrapper">
    <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">Form Tambah Data Barang Validasi </h1>
                        </div> 
                        <!-- /.col-lg-12 -->
                    </div>
                        ...
                        <div class="col-lg-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    Input Data Barang Validasi 
                                </div>
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-lg-6">
                                        
                                            <form role="form" action="<?= site_url('/submitbarangbaru_validasi') ?>">
                                                ...
                                                <a type="button" class="btn btn-primary" href="<?= base_url('/daftarnamabarang_validasi')?>" id="buttontambahbarang" style="margin:auto;height:20%;margin-bottom:10px;"><i class="fa fa-plus" aria-hidden="true"></i>Tambah Nama Barang </a>
                                                <a type="button" class="btn btn-danger" href="<?= base_url('/hapusnamabarang_validasi')?>" id="buttontambahbarang" style="margin:auto;height:20%;margin-bottom:10px;"><i class="fa fa-plus" aria-hidden="true"></i>Hapus Nama Barang </a>
