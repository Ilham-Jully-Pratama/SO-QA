...
$routes->get('/ubahbarang(:any)', 'Home::ubahbarang/$1',['filter'=>'role:supervisor,admin_kalkual']);
$routes->get('/submit_ubah_barang(:any)', 'Home::submit_ubah_barang/$1',['filter'=>'role:supervisor,admin_kalkual']);
//tambah barang baru
$routes->get('/tambah_data_barang', 'Home::tambah_data_barang',['filter'=>'role:supervisor,admin_kalkual']);
$routes->get('/submitbarangbaru', 'Home::submitbarangbaru',['filter'=>'role:supervisor,admin']);
$routes->delete('/delete_barang(:num)','Home::delete/$1',['filter'=>'role:supervisor,admin']);
$routes->get('/daftarnamabarang', 'Home::daftarnamabarang',['filter'=>'role:supervisor,admin']);
$routes->post('/submitnamabarang', 'Home::submitnamabarang',['filter'=>'role:supervisor,admin']);

$routes->get('/hapusnamabarang', 'Home::hapusnamabarang',['filter'=>'role:supervisor,admin']);
$routes->delete('/deletedaftarnamabarang(:num)','Home::deletedaftarnamabarang/$1',['filter'=>'role:supervisor,admin']);
// barang masuk
$routes->get('/barang_masuk(:any)','Home::barang_masuk/$1',['filter'=>'role:supervisor,admin']);
$routes->get('/submit_barang_masuk', 'Home::submit_barang_masuk',['filter'=>'role:supervisor,admin']);
$routes->get('/laporanbarangmasuk', 'Home::laporanbarangmasuk',['filter'=>'role:supervisor,admin']);
$routes->delete('/deletebarangmasuk(:num)','Home::deletebarangmasuk/$1',['filter'=>'role:supervisor,admin']);
$routes->get('/ubah_barang_masuk(:any)', 'Home::ubahbarangmasuk/$1',['filter'=>'role:supervisor,admin']);
$routes->post('/submit_ubah_barang_masuk(:any)', 'Home::submit_ubah_barang_masuk/$1',['filter'=>'role:supervisor,admin']);
$routes->post('/caridatamasuk', 'Home::caridatamasuk',['filter'=>'role:supervisor,admin']);
$routes->get('/caridatamasuk', 'Home::laporanbarangmasuk',['filter'=>'role:supervisor,admin']);
// barang keluar
$routes->get('/barang_keluar(:any)','Home::barang_keluar/$1',['filter'=>'role:supervisor,admin,user,admin_qa']);
$routes->get('/submit_barang_keluar(:any)', 'Home::submit_barang_keluar/$1',['filter'=>'role:supervisor,admin,user,admin_qa']);
$routes->get('/laporanbarangkeluar', 'Home::laporanbarangkeluar',['filter'=>'role:supervisor,admin,user,admin_qa']);
$routes->delete('/deletebarangkeluar(:num)','Home::deletebarangkeluar/$1',['filter'=>'role:supervisor,admin']);
$routes->post('/caridatakeluar','Home::caridatakeluar',['filter'=>'role:supervisor,admin']);
//user
...
$routes->get('/cekbarangqa', 'Home::cekbarangqa',['filter'=>'role:supervisor,admin']);
$routes->get('/dashboardqakalkual', 'Home::dashboardqakalkual',['filter'=>'role:supervisor,admin']);
$routes->get('/baranghabiskalkual', 'Home::baranghabiskalkual',['filter'=>'role:supervisor,admin']);
$routes->get('/barangedkalkual', 'Home::barangedkalkual',['filter'=>'role:supervisor,admin']);
...
$routes->get('/daftarnamabarang_adminqa', 'Admin_QA::daftarnamabarang_adminqa');
