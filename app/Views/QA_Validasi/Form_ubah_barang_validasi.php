...
<div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">Form Ubah Barang Validasi </h1>
                        </div> 
                        <!-- /.col-lg-12 -->
                    </div>
                    <!-- /.row -->
                                ...
                                <div id="flash2" data-flash="<?= esc(session()->getFlashdata('pesan')); ?>">
                                    <div class="row">
                                        ...
                                        <?php foreach ($masuk as $dd) : ?>
                                            <form role="form" method="post" action="<?= site_url('/submit_ubah_barang_validasi/'.$dd['id']) ?>">
                                                ...
                                                <button type="button" class="btn btn-warning" onclick="window.location.href='<?= site_url('/databarang_validasi'); ?>';">Kembali</button>
