...
<div id="page-wrapper">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header"> Dashboard Admin QA </h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <!-- /.row -->
            ...
            <div class="col-lg-6">
                <div class="panel panel-red">
                    ...
                    <div class="panel-footer">
                        <a type="button" class="btn btn-danger" href="<?= base_url('/baranghabisadminqa')?>" style="margin:auto;height:20%; color: white;">Lihat Detail</a>
                    </div>
                 </div>
            </div>
        </div>
