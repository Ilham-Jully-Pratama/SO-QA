                                ...
                                <div id="flash2" data-flash="<?= esc(session()->getFlashdata('alert')); ?>">
                                    <div class="row">
                                        ...
                                        <?php foreach ($masuk as $dd) : ?>
                                            <form role="form" action="<?= site_url('/submit_brg_keluar'. $dd['kodebarang']) ?>" method="post">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control <?= session('validation') ? (session('validation')['keterangan'] ? 'is-invalid' : '') : ''; ?>"type="text"name="keterangan" >
                                                    <p class="help-block">Keterangan Pengambilan Barang </p>
                                                    <small>
                                                        <span class="text-danger"><?= session('validation') ? session('validation')['keterangan'] : ''; ?></span>
                                                    </small>
                                                </div>
                                                <div class="form-group">
                                                    <label>Tanggal</label>
