                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <?php foreach ($users as $dd) : ?>
                                        <tr class="odd gradeX">
                                            ...
                                            <td><?= $dd['email']; ?></td>
                                            <td><?= $dd['role']; ?></td>
                                            <td><a type="button" class="btn btn-info" href="<?= base_url('/updateuser'.$dd['id']) ?>" id="buttonupdate" style="margin:auto;height:20%"><i class="fa fa-pencil" aria-hidden="true"></i></a></td>
                                            <td>
                                                <form action="<?= site_url('/deleteuser'.$dd['id']) ?>" method="post">
